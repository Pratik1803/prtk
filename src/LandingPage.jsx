  ...
  return (
    <section id="landing_page">
      ...
      <div className="landingPage_info">
        ...
        <p id="landingPage_p" style={{ fontSize: "0.8rem", padding: '20px 0', letterSpacing: '0px', fontWeight: '100', width: '80%' }}>Looking for a Front End developer who can convert your awesome designs into a fully functioning website? You've just come to the right place.</p>
        <div id="social_links">
